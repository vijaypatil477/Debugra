  ...
  const handleEditorWillMount = (monaco) => {
    ...
    monaco.editor.defineTheme('cobalt', {
      ...
      rules: [
        ...
        { token: 'function', foreground: 'ffd2a7' },
        { token: 'variable', foreground: 'cccccc' },
        { token: 'variable.predefined', foreground: '9effff' },
        { token: 'operator', foreground: 'ff9d00' },
        { token: 'delimiter', foreground: 'cccccc' },
        { token: 'tag', foreground: '9effff' },
        { token: 'attribute.name', foreground: 'ffd2a7' },
      ...
      colors: {
        ...
        'editorLineNumber.foreground': '#0088ff80',
        'editorLineNumber.activeForeground': '#9effff',
        'editorIndentGuide.background1': '#00346e',
        'editorIndentGuide.activeBackground1': '#9effff',
        'editorBracketHighlight.foreground1': '#9effff',
        'editorBracketHighlight.foreground2': '#ffd2a7',
        'editorBracketHighlight.foreground3': '#3ad900',
        'editorBracketHighlight.foreground4': '#ff9d00',
        'editorBracketHighlight.foreground5': '#ff628c',
        'editorBracketHighlight.foreground6': '#80ffbb',
        'editorBracketMatch.background': '#9effff33',
        'editorBracketMatch.border': '#9effff',
        'editor.findMatchBackground': '#b36539bf',
        'editor.findMatchHighlightBackground': '#ff9d0040',
        'editorGutter.background': '#002240',
        'scrollbar.shadow': '#001830',
        'scrollbarSlider.background': '#0088ff40',
        'scrollbarSlider.hoverBackground': '#0088ff80',
        'scrollbarSlider.activeBackground': '#0088ffbf',
      },
    });
    ...
    monaco.editor.defineTheme('synthwave-84', {
      ...
      colors: {
        ...
        'editor.selectionBackground': '#463465bf',
        'editorCursor.foreground': '#ff7edb',
        'editorLineNumber.foreground': '#848bbd80',
        'editorLineNumber.activeForeground': '#ff7edb',
        'editorIndentGuide.background1': '#34294f',
        'editorIndentGuide.activeBackground1': '#ff7edb',
        'editorBracketHighlight.foreground1': '#36f9f6',
        'editorBracketHighlight.foreground2': '#ff7edb',
        'editorBracketHighlight.foreground3': '#fede5d',
        'editorBracketHighlight.foreground4': '#fe4450',
        'editorBracketHighlight.foreground5': '#f97e72',
        'editorBracketHighlight.foreground6': '#ff8b39',
        'editorBracketMatch.background': '#ff7edb33',
        'editorBracketMatch.border': '#ff7edb',
        'editor.findMatchBackground': '#fe445040',
        'editor.findMatchHighlightBackground': '#fede5d30',
        'editorGutter.background': '#262335',
        'scrollbar.shadow': '#1a1a2e',
        'scrollbarSlider.background': '#ff7edb30',
        'scrollbarSlider.hoverBackground': '#ff7edb60',
        'scrollbarSlider.activeBackground': '#ff7edb90',
      },
    });
  };
