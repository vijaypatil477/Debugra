...
export default function ContactPage() {
  ...
  const handleSubmit = (event) => {
    ...
    setSubmitted(true);
    toast.success('Thanks for reaching out to Debugra!');
    setForm(initialForm);
    ...
    <div className="feedback-page">
      <div className="feedback-shell">
        <div className="feedback-copy">
          ...
          <h1 className="feedback-title">Get in touch with the Debugra team.</h1>
          <p className="feedback-subtitle">
            Use the form below to share feedback, questions, bugs, or collaboration ideas. We’ll
          ...
          {submitted && (
            <div className="feedback-success" role="status">
              Your message was captured. Thank you for reaching out.
            </div>
          )}
        </div>
        ...
        <form className="feedback-form" onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="6"
              placeholder="Tell us what you need, what you noticed, or how we can help..."
              required
            />
          </label>
